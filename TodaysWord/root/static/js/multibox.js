/**************************************************************
    ...
    Marilyn Added: 
        - Enabled option, with a turn on and turn off variable
        - Fixed onOpen and onClosed
        - Added the close button to the showControls option
...
var multiBox = new Class({
	...
	getOptions: function(){
		return {
			...
			onClose: $empty,
			openFromLink: true,
            enabled: true // Allow the multibox to work
	...
	setContentType: function(link){
		...
		switch(str){
			...
			case 'element':
				...
				this.contentObj.showControlsheight = this.elementContent.getSize().y;
				this.elementContent.setStyles({
					display: 'none',
					opacity: 1
				})
