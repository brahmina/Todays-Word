use utf8;
package TodaysWord::Schema::Result::AdImpression;
...
=head1 TABLE: C<ad_impression>

=cut

__PACKAGE__->table("ad_impression");
...
Related object: L<TodaysWord::Schema::Result::Advert>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8RMyZCEfQzwx0x+78cuPKw
